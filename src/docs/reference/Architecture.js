...
var Architecture = React.createClass({
  componentDidMount: function () {
    A11y.updatePageTitle('Architecture');
  },
      ...
      <DocsArticle title="Architecture" colorIndex="neutral-4">
        <section>
          ...
          <p>
            ...
            Under the hood, you'll find <a href="http://inuitcss.com/" target="_blank">InuitCSS</a> and <a href="http://sass-lang.com/" target="_blank">Sass</a> to
