      ...
      <DocsArticle title="Usability" colorIndex="neutral-1">
        <section>
          <dl>
            ...
            <dd>Minimize content and avoid clutter in the interface by
              presenting the user with
            only the elements that make sense at a given point in the
            experience.
            ...
            instead, or highlight important data and messages with proper
            styling.</dd>
