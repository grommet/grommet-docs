...
var Philosophy = React.createClass({
  render: function () {
    return (
      <DocsArticle title="Philosophy" colorIndex="neutral-1">
        <p>Our philosophy of user experience design is based on understanding
        ...
        We hope these serve as the footing of your next project.</p>

        <section>
          <a className="reference" id="best-practices"> </a>
          <h2>Best Practices</h2>

          <dl>
            <dt>Know your users</dt>
            <dd>It's critically important that you know your users.  Get to know some of them
        ...
        <section>
          <a className="reference" id="usability"> </a>
          <h2>Usability</h2>
        ...
        <section>
          <a className="reference" id="interactions"> </a>
          <h2>Interactions</h2>
        ...
        <section>
          <a className="reference" id="mobile"> </a>
          <h2>Mobile</h2>
        ...
        <section>
          <a className="reference" id="accessibility"> </a>
          <h2>Accessibility</h2>
